...
export default function ListAutores() {
  return (
    <div className="mx-auto max-w-7xl">
      ...
      <header className="flex flex-col items-start justify-between gap-4 md:flex-row md:items-center">
        ...
        <Link
            to="/admin/autores/add" // <-- La nueva ruta
            ...
            <span className="truncate">Nuevo Autor</span>
        </Link>
      </header>
          ...
          <table className="w-full text-left text-sm">
            <thead className="border-b border-border-light text-xs uppercase text-neutral-gray dark:border-border-dark dark:text-neutral-400">
              <tr>
                ...
                <th scope="col" className="px-6 py-3">Rol Autor</th>
                <th scope="col" className="px-6 py-3 text-right">Acciones</th>
              </tr>
            </thead>
            <tbody>
              <tr className="border-b border-border-light dark:border-border-dark">
                <td className="px-6 py-4 font-medium text-dark-charcoal dark:text-white">Gabriel García Márquez</td>
                <td className="px-6 py-4 text-neutral-gray">Novelista</td>
