...
export default function ListTiposLiteratura() {
  return (
      ...
      <header className="flex flex-col items-start justify-between gap-4 md:flex-row md:items-center">
        <div className="flex flex-col gap-2">
          ...
          <p className="text-neutral-gray text-base font-normal leading-normal">
            Manage and organize all literature types within the library.
          </p>
        </div>
        <Link
          to="/admin/tipos/add" // Enlace al formulario que creamos antes
        ...
        >
          ...
          <span className="truncate">Create New Type</span>
        </Link>
      </header>
            ...
            <div className="overflow-hidden rounded-lg border border-border-light dark:border-border-dark">
              <table className="min-w-full divide-y divide-border-light dark:divide-border-dark">
                ...
                <tbody className="divide-y divide-border-light dark:divide-border-dark">
                  <tr>
                    <td className="whitespace-nowrap px-6 py-4 text-sm font-medium text-dark-charcoal dark:text-white">Novela</td>
                  ...
                  <tr>
                    <td className="whitespace-nowrap px-6 py-4 text-sm font-medium text-dark-charcoal dark:text-white">Poesía</td>
                    <td className="whitespace-nowrap px-6 py-4 text-right text-sm font-medium">
                      <div className="flex items-center justify-end gap-4">
                        <Link className="flex items-center gap-1 text-neutral-gray hover:text-primary" to="#">
                          <span className="material-symbols-outlined text-lg">edit</span>
        ...
        <nav className="flex items-center justify-between border-t border-border-light px-4 py-3 dark:border-border-dark sm:px-6">
          <div className="hidden sm:block">
            <p className="text-sm text-neutral-gray">
              ...
              of
              <span className="font-medium text-dark-charcoal dark:text-white"> 15 </span>
              results
            </p>
          </div>
