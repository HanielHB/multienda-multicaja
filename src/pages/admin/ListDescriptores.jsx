...
export default function ListDescriptores() {
  return (
      ...
      <header className="flex flex-col items-start justify-between gap-4 md:flex-row md:items-center">
        <div className="flex flex-col gap-2">
          ...
          <p className="text-neutral-gray text-base font-normal leading-normal">
            Gestiona los términos descriptivos utilizados en la biblioteca.
          </p>
        </div>
        {/* Convertí el botón en un Link que va al formulario que ya creamos */}
        <Link
          to="/admin/descriptores/add"
        ...
        >
          ...
          <span className="truncate">Nuevo Descriptor</span>
        </Link>
      </header>
          ...
          <table className="w-full text-left text-sm">
            ...
            <tbody>
              <tr className="border-b border-border-light dark:border-border-dark">
                <td className="px-6 py-4 font-medium text-dark-charcoal dark:text-white">Realismo mágico</td>
