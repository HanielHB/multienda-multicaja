  ...
  return (
    <div className="bg-background-light dark:bg-background-dark font-display text-dark-charcoal dark:text-background-light">
      <div className="relative flex min-h-screen w-full">
        ...
        <aside
          className={`fixed inset-y-0 left-0 w-64 flex flex-col justify-between border-r border-border-light bg-white p-4 dark:border-border-dark dark:bg-background-dark overflow-y-auto z-50 transform transition-transform duration-300 ease-in-out ${sidebarOpen ? "translate-x-0" : "-translate-x-full"} lg:translate-x-0`}
        >
          <div className="flex flex-col gap-8">
            ...
            <div className="flex items-center gap-3 px-2">
              ...
              <div className="flex flex-col">
                <h1 className="text-dark-charcoal dark:text-white text-base font-bold leading-normal">
                  Jani Shoes
                </h1>
            ...
            <nav className="flex flex-col gap-2">
              ...
              {["administrador", "supervisor"].includes(user?.tipo) && (
                ...
                >
                  ...
                  <p
                    className={`text-sm leading-normal ${isActive("/admin/dashboard") ? "font-bold" : "font-medium"}`}
                  >
                    Dashboard
                  </p>
                </Link>
              ...
              {["administrador", "supervisor"].includes(user?.tipo) && (
                ...
                >
                  ...
                  <p
                    className={`text-sm leading-normal ${isActive("/admin/productos") || location.pathname.startsWith("/admin/productos") ? "font-bold" : "font-medium"}`}
                  >
                    Productos
                  </p>
                </Link>
              ...
              {["administrador"].includes(user?.tipo) && (
                ...
                >
                  ...
                  <p
                    className={`text-sm leading-normal ${isActive("/admin/categorias") || location.pathname.startsWith("/admin/categorias") ? "font-bold" : "font-medium"}`}
                  >
                    Categorías
                  </p>
                </Link>
              ...
              {["administrador", "supervisor", "cajero"].includes(
                user?.tipo,
              ) && (
                <Link
                  className={`flex items-center gap-3 rounded-lg px-3 py-2 transition-colors ${
                ...
                >
                  ...
                  <p
                    className={`text-sm leading-normal ${isActive("/admin/clientes") || location.pathname.startsWith("/admin/clientes") ? "font-bold" : "font-medium"}`}
                  >
                    Clientes
                  </p>
                </Link>
              ...
              {["administrador"].includes(user?.tipo) && (
                <Link
                  className={`flex items-center gap-3 rounded-lg px-3 py-2 transition-colors ${
                    isActive("/admin/sucursales") ||
                    location.pathname.startsWith("/admin/sucursales")
                      ? "bg-primary/10 text-primary"
                      : "text-neutral-gray hover:bg-primary/10 hover:text-primary"
                  }`}
                  to="/admin/sucursales"
                >
                  ...
                  <p
                    className={`text-sm leading-normal ${isActive("/admin/sucursales") || location.pathname.startsWith("/admin/sucursales") ? "font-bold" : "font-medium"}`}
                  >
                    Sucursales
                  </p>
                </Link>
              ...
              {["administrador", "supervisor"].includes(user?.tipo) && (
                ...
                >
                  ...
                  <p
                    className={`text-sm leading-normal ${isActive("/admin/usuarios") || location.pathname.startsWith("/admin/usuarios") ? "font-bold" : "font-medium"}`}
                  >
                    Usuarios
                  </p>
                </Link>
              ...
              {["administrador"].includes(user?.tipo) && (
                <Link
                  className={`flex items-center gap-3 rounded-lg px-3 py-2 transition-colors ${
                    isActive("/admin/almacenes") ||
                    location.pathname.startsWith("/admin/almacenes")
                      ? "bg-primary/10 text-primary"
                      : "text-neutral-gray hover:bg-primary/10 hover:text-primary"
                  }`}
                  to="/admin/almacenes"
                >
                  ...
                  <p
                    className={`text-sm leading-normal ${isActive("/admin/almacenes") || location.pathname.startsWith("/admin/almacenes") ? "font-bold" : "font-medium"}`}
                  >
                    Almacenes
                  </p>
                </Link>
              ...
              {["administrador", "supervisor", "cajero"].includes(
                ...
                >
                  ...
                  <p
                    className={`text-sm leading-normal ${isActive("/admin/inventario") || location.pathname.startsWith("/admin/inventario") ? "font-bold" : "font-medium"}`}
                  >
                    Inventario
                  </p>
                </Link>
              ...
              {["administrador", "supervisor", "cajero"].includes(
                ...
                <Link
                  className={`flex items-center gap-3 rounded-lg px-3 py-2 transition-colors ${
                    isActive("/admin/apertura-cajas") ||
                    location.pathname.startsWith("/admin/apertura-cajas")
                      ? "bg-primary/10 text-primary"
                      : "text-neutral-gray hover:bg-primary/10 hover:text-primary"
                  }`}
                ...
                >
                  ...
                  <p
                    className={`text-sm leading-normal ${isActive("/admin/apertura-cajas") || location.pathname.startsWith("/admin/apertura-cajas") ? "font-bold" : "font-medium"}`}
                  >
                    Apertura Cajas
                  </p>
                </Link>
              ...
              {["administrador", "supervisor", "cajero"].includes(
                ...
                <Link
                  className={`flex items-center gap-3 rounded-lg px-3 py-2 transition-colors ${
                    isActive("/admin/punto-venta") ||
                    location.pathname.startsWith("/admin/punto-venta")
                ...
                >
                  ...
                  <p
                    className={`text-sm leading-normal ${isActive("/admin/punto-venta") || location.pathname.startsWith("/admin/punto-venta") ? "font-bold" : "font-medium"}`}
                  >
                    Punto de Venta
                  </p>
                </Link>
              ...
              {["administrador", "supervisor"].includes(user?.tipo) && (
                ...
                >
                  ...
                  <p
                    className={`text-sm leading-normal ${isActive("/admin/reportes") || location.pathname.startsWith("/admin/reportes") ? "font-bold" : "font-medium"}`}
                  >
                    Reportes
                  </p>
                </Link>
              ...
              {["administrador"].includes(user?.tipo) && (
                ...
                >
                  ...
                  <p
                    className={`text-sm leading-normal ${isActive("/admin/backup") || location.pathname.startsWith("/admin/backup") ? "font-bold" : "font-medium"}`}
                  >
                    Backup
                  </p>
                </Link>
              ...
              >
                <span
                  className={`material-symbols-outlined text-3xl ${
                    hasCajaAbierta ? "text-amber-500" : "text-blue-500"
                  }`}
                >
                ...
                {hasCajaAbierta ? (
                  <>
                    ...
                    <span className="block text-sm">
                      ...
                      ¿Estás seguro de que deseas cerrar sesión de todas formas?
                    </span>
                  </>
                ) : (
